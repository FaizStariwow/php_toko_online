                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="../../action/produk_action/insert_produk_act.php" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="id" id="" value="<?= $data['id']?>">
                                    <div class="mb-3 mt-4">
                                        <label for="exampleInputtext1" class="form-label">Nama</label>
                                        <input type="text" class="form-control" id="exampleInputtext1" name="nama"  >
                                    </div>
                                    <div class="mb-3">
