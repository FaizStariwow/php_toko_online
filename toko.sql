...
CREATE TABLE IF NOT EXISTS `transaksi` (
  ...
  `alamat_pengiriman` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `total_harga` int NOT NULL,
  `jumlah` int NOT NULL,
...
INSERT INTO `user` (`id`, `nama`, `username`, `email`, `password`) VALUES
	(2, 'Argus', 'Atmin', 'atmin@gmail.com', '12345'),
	(3, 'Suki', 'Suki', 'suki@gmail.com', '12345'),
	(4, 'faiz', 'FaizSatrio', 'faiz@gmail.com', '12345'),
	(6, 'Radit', 'Radittumapel', 'alqaybulzakyyy@gmail.com', '12345');
